...
#include "openpifpaf_furniture/decoder/cifdet.hpp"
...
// But didn't test the cifdet
    ...
    for (int64_t seed_i=0; seed_i < seeds_f.size(0); seed_i++) {
        ...
        x = seeds_vxywh_a[seed_i][5];
        y = seeds_vxywh_a[seed_i][6];
        w = seeds_vxywh_a[seed_i][7];
        h = seeds_vxywh_a[seed_i][8];
