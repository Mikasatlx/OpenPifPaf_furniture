...
class KeypointPainter(openpifpaf.configurable.Configurable):
    """Paint poses.
...
########################################################################################################
    @classmethod
    def _draw_category(cls, ax, x8, y8, curr_category, color):
        text_category = None
        if curr_category == 1:
            text_category = 'Bed'
...
########################################################################################################
    def annotation(self, ax, ann, *, color=None, text=None, subtext=None, alpha=1.0):
        ...
        self._draw_category(ax, kps[8, 0], kps[8, 1], curr_category, color)
